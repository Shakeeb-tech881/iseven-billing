...
const DEFAULT_SETTINGS = {
  ...
  biz_lines: "No. 63, First Floor, Liberty Plaza, Colombo 03\n+94 77 311 1999 \u00b7 info@iseven.lk",
  ...
  const items = (Array.isArray(body.items) ? body.items : [])
    ...
    .map((it, i) => {
      ...
      return {
        ...
        /* ...and whether to print the number of days ("365 days"). */
        show_days: it.show_days === undefined ? true : Boolean(it.show_days),
